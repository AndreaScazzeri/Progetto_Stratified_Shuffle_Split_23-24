...
class StratifiedShuffleSubsamplingSplitter(Splitting):
    def split(self, df: pd.DataFrame, ps, n_divisioni, seed=1):
        '''
        ...
        for i in range(1,n_divisioni):
            ...
            numerosita_attesa_classe2=ps*len(df_classe2)
            numerosita_attesa_classe4=ps*len(df_classe4)
